        ...
        <>
            <CenterContainer >
                <div className="w-[90%] flex flex-col items-center justify-center gap-4">
                    ...
                    <Link to="/login" className="cursor-pointer text-white hover:text-sky-800 transition-all bg-sky-500 p-3 rounded-xl hover:bg-sky-800 cursor-pointer w-full text-center">Login Now</Link>
                </div>
            </CenterContainer>
        </>
    )
