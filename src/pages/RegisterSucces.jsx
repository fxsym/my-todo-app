            ...
            <CenterContainer >
                <div className="w-[90%] flex flex-col lg:flex-row items-center justify-center gap-4">
                    ...
                    <div className="flex flex-col items-center justify-center gap-4 lg:gap-6 lg:w-1/2">
                        <h1 className="text-3xl text-center lg:text-4xl">Your account has been created</h1>
                        <h1 className="text-sm text-center text-gray-500 md:text-lg lg:text-xl">Congratulations! Your account has been created now and your ready to acces your todo list from anywhere and everywhere</h1>
