    ...
    return (
        ...
        <MainLayout>
            ...
            <div className="w-[90%] flex flex-col items-center justify-center gap-4">
                    ...
                    <Link to="/register" className="cursor-pointer text-white transition-all bg-sky-400 p-3 rounded-xl hover:bg-sky-800 cursor-pointer w-full text-center">Get Started</Link>
                </div>
        </MainLayout>
