            ...
            <MainLayout>
                <div className="flex flex-col items-center justify-center gap-4">
                    <div className="flex flex-col items-center mt-10 gap-4 py-2 px-8">
                        ...
                        <p className="text-md text-gray-400 text-center">SkyList is a sleek, cloud-based to-do list app that helps users organize and access tasks anytime, anywhere.</p>
                        <div className="flex flex-col w-full gap-1">
                            ...
                            <p className="text-sm text-gray-400 text-center">Start now, with a simple step!.</p>
                        </div>
                    </div>
