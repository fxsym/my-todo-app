        ...
        <>
            <CenterContainer>
                <div className="flex items-center lg:justify-evenly lg:px-26 overflow-hidden">
                    <div className="font-[Poppins] w-120 flex flex-col gap-6 lg:w-2/3 p-14 ">
                            <h1 className="text-3xl font-bold lg:text-5xl">Login to your account </h1>
                            <p className="text-sm text-gray-500 lg:text-xl">You must have an account first to be able to log in. Log in and save the activities you will do, access from anywhere and anytime.</p>
                        <div className="">
                            <form action="" className="flex flex-col items-center gap-2" onSubmit={handleSubmit}>
                                ...
                                {loading ? <LoaderRing /> : ""}
                                <button className="bg-sky-500 py-4 w-full rounded-xl mt-4 text-white cursor-pointer hover:bg-sky-800 transition-all text-lg lg:text-xl lg:py-6">Login</button>
                            ...
                            <div className="flex justify-center mt-4">
                                <p className="lg:text-lg">Don't have account ? <Link to="/register" className=" underline cursor-pointer text-sky-500 hover:text-sky-800 transition-all lg:text-lg">Create Account</Link></p>
                            </div>
                        </div>
                    </div>
